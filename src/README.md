To compile and run the game you must have Python 3 installed on command line. For more information on how to do this please follow the instructions in this link: https://realpython.com/installing-python/.
