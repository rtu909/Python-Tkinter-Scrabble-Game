...
\begin{enumerate}
    ...
    \item{test-UI12:Test for when the word inputted vertically forms a valid word with existing word/letter.\\} %FR9
    Type: Functional, Dynamic, Manual\\
...
\begin{enumerate}
    ...
    \item{test-GE5: Test that upon arrival of end state game exits board.\\} %FR12
    Type: Functional, Dynamic, Manual\\
