...
\begin{table}[!htb]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        Event Name & \textcolor{red}{Input/Output} & Summary \\
        \hline
        Player places word & \textcolor{red}{word, row, col, dir (in)}& System checks if word exists in dictionary and if placement is valid.\\
        Player exchanges tiles & \textcolor{red}{letters to exchange (in)} & System takes discarded tiles and randomly assigns new ones to player. \\
        All tiles are played & \textcolor{red}{player rack, bag(in)} & System checks win state to see which player won. \\ 
        \sout{ Board is full} & \sout{--} & \sout{System checks win state to see which player won.} \\
        \textcolor{red}{Skip turn} & \textcolor{red}{skip (in)} & \textcolor{red}{System
        switches player racks and indicates it is the next player's turn.}\\
        \textcolor{red}{Switch Turn} & \textcolor{red}{playerTurn (in)} & \textcolor{red}{System
        switches player racks and indicates it is the next player's turn.}\\
        \textcolor{red}{Score} & \textcolor{red}{player score (in)} & \textcolor{red}{System
        adds value of placed word to the current score.}\\
        \hline
    \end{tabular}}
\end{table}
...
\begin{enumerate} %raymond 1-4
    \item 
    \sout{Requirement Number: FR1} \\ %obsolete
    ...
    \item 
    \sout{Requirement Number: FR3} \\ %obsolete
...
\begin{enumerate}
    \item NFR Number: \sout{UH6} \textcolor{red}{UH7}\\ %%LUCIA
    ...
    Fit Criterion: After a single game 90\% of users will report little to no frustration when surveyed about their game experience.
     \item NFR Number: \sout{UH7} \textcolor{red}{UH8}\\ %%LUCIA
...
\begin{enumerate}
    ...
    \item NFR Number: \sout{MS1} \textcolor{red}{MS2}\\ %%RAYMOND
    ...
    \item NFR Number: \sout{MS1} \textcolor{red}{MS3}\\ %%RAYMOND
